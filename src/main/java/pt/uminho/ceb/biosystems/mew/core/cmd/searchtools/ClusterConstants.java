...
public final class ClusterConstants {
	...
	public static final String		REMOTE_MONITOR_STRING	= "-Djava.rmi.server.hostname=XXX.XXX.XXX.XXX -Dcom.sun.management.jmxremote.port=1100 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false";
	...
	public static final String		LP_SOLVER				= CPLEX3SolverBuilder.ID;
	public static final String		MILP_SOLVER				= CPLEX3SolverBuilder.ID;
	public static final String		QP_SOLVER				= CPLEX3SolverBuilder.ID;
